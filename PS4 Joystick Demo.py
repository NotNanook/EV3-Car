# Quelle: https://stackoverflow.com/questions/63114011/ps4-controller-cursor-not-moving-when-value-is-1
...
class PS4Joystick:
    ...
    PS4ButtNames = [ 'eX', 'Oh', 'Pointy', 'Square', 'L1', 'R1', 'L2', 'R2', 'Share', 'Options', 'PS' , 'joystick_left', 'joystick_right']
